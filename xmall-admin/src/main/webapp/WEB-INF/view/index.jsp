...
<html>
	...
	<body class="hold-transition skin-blue sidedar-mini">
		<div class="wrapper">
			<header class="main-header">
			<a href="#" class="logo">
					<span class="logo-mini"><b>XML</b></span>
					<span class="logo-lg"><b>XMALL</b></span>
			</a>
			<nav class="navbar navbar-static-top">
				...
				<div class="navbar-custm-menu">
						<ul class="nav varbar-nar" >
							<li class="dropdawn messages=menu">
